...
export default function BookingForm() {
  ...
  // removed voucher: only 3 fields now
  ...
  const submit = (e: React.FormEvent) => {
    ...
    if (destination) params.set("hotel", destination);
    if (checkin) params.set("checkin", formatDate(checkin, "yyyy-MM-dd"));
    if (checkout) params.set("checkout", formatDate(checkout, "yyyy-MM-dd"));
        ...
        <Form className="booking-form" onSubmit={submit}>
          <Row className="g-3 g-lg-3 align-items-stretch booking-row-bottom">
            ...
            <Col xs={12} sm={6} md={3} lg={3}>
              <div className="booking-card p-2 h-100 d-flex align-items-end">
                <div className="wrap w-100">
                  <label className="label label-booking">Where do you want to stay?</label>
            ...
            <Col xs={12} sm={6} md={3} lg={3}>
              <div className="booking-card p-2 h-100 d-flex align-items-end">
                <div className="wrap w-100">
                  <label className="label label-booking">Check-in - Check-out</label>
                  <div className="input-with-icon">
            ...
            <Col xs={12} sm={6} md={3} lg={2}>
              <div className="booking-card p-2 h-100 d-flex align-items-end">
                <div className="wrap w-100">
                  <label className="label label-booking">Number of Rooms</label>
