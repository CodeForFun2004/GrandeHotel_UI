...
const Hero = styled.aside<{
  ...
  ${({ sliding }) =>
    sliding &&
    css`
      animation: ${bgOutRight} 0.55s ease forwards;
    `}
`;
...
const LoginPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await dispatch(
        loginUser({ usernameOrEmail: email.trim(), password })
      ).unwrap();
              ...
              <Card>
                <form onSubmit={handleSubmit} noValidate>
                    ...
                    >
                      {showPw ? (
                        ...
                        >
                          ...
                          />
                          <path
                            d="M2 12s4-7 10-7c2.1 0 4 .7 5.6 1.7"
                            stroke="currentColor"
                            strokeWidth="1.6"
                            fill="none"
                            strokeLinecap="round"
                          />
                          <path
                            d="M22 12s-4 7-10 7c-2.2 0-4.1-.7-5.8-1.9"
                            stroke="currentColor"
                            strokeWidth="1.6"
                            fill="none"
                            strokeLinecap="round"
                          />
                          <path
                            d="M9.5 9.5a4.5 4.5 0 0 0 6.4 6.3"
                            stroke="currentColor"
                            strokeWidth="1.6"
                            fill="none"
                          />
                  ...
                  <Row>
                    ...
                    <LinkA href="#" onClick={handleForgot}>
                      Forgot password?
                    </LinkA>
                  </Row>

                  <Btn primary type="submit" disabled={!canSubmit || loading}>
                  ...
                  <Btn type="button" onClick={handleGoogleLogin}>
                    <div
                      style={{
                        display: "flex",
                        alignItems: "center",
